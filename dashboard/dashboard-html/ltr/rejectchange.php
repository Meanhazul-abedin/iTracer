...
function save ($id) {
    ...
    $sql = "INSERT INTO rejected(id, projectID,issueID, developer, tester ) VALUES ('$id', '$projectid', '$issueid', '$developer', '$tester');";
    ...
    $sql = "UPDATE done SET projectID=' ',issueID= ' ', developer= ' ', tester= ' ' WHERE id='".$id."'";
